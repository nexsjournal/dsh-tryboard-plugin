...
console.log("\n# static: sidebar footer entries stack vertically (shell v2.0.1+ row layout)");
{
  ...
  check("market launcher mask override present (brand plugin icon)", src.includes(".dshMarketLauncher > span{display:none !important}") && src.includes('.dshMarketLauncher[data-wide="true"]::before{width:16px;height:16px}'));
}
